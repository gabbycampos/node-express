...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2021-04-20T01:44:48.780914" />
  ...
  <link href="/media/css/fontawesome.css?d74fef76" rel="stylesheet">
  ...
  <link rel="shortcut icon" href="/favicon.ico" />
    ...
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?d74fef76">
      ...
      <div class="text">
        <ul>
            ...
            <li class=" ">
              ...
              2021-05-12 &middot; <a href="/about/event/postgreslondon-2021-2407/">PostgresLondon 2021</a>
            </li>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-april-18-2021-2199/">PostgreSQL Weekly News - April 18, 2021</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-04-19 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgmetrics-111-released-2196/">pgmetrics 1.11 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-04-17 by RapidLoop, Inc.</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/hypopg-12-is-out-2177/">HypoPG 1.2 is out!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-04-17 by Julien Rouhaud</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/call-for-papers-for-postgres-vision-2021-is-extended-to-april-19-2198/">Call for Papers for Postgres Vision 2021 is Extended to April 19!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-04-17 by EDB</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-april-11-2021-2195/">PostgreSQL Weekly News - April 11, 2021</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-04-12 by PWN</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/537"> Challenging Assumptions</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Bruce Momjian</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-04-19</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/538"> Pavlo Golub</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/536"> Calling Stored Procedure from JAVA – Part 2</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/535"> Visibility with query cache</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/534"> pspg 4.6.0 released</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Pavel Stehule</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-04-18</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/533"> How difficult is to create a database software like PostgreSQL ?</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Avinash Vallarapu</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-04-17</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/532"> Your Guide to Connection Management in Postgres</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Craig Kerstiens</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-04-16</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/531"> Rerouting Server Log Entries</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Bruce Momjian</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-04-16</li>
            </ul>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/530"> Benchmarking PostgreSQL: Setting up a RAID Array from Scratch</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Vik Fearing</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-04-15</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?d74fef76"></script>
